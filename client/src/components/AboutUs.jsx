          ...
          >
            ...
            <div className="space-y-4 mb-8">
              <p className="text-gray-600 leading-relaxed">
                <span className="font-semibold text-blue-600">Accurate Astro</span> represents disciplined, logic-based Vedic astrology.
Practicing since 2018 and raised in a traditional astrological family, I combine classical principles with structured analytical methods. A B.Com (Honours) graduate from Calcutta University, I approach every chart with precision, not assumption.
              </p>
              
              <p className="text-gray-600 leading-relaxed">
                No exaggeration.
No fear-based remedies.
Only calculated interpretation and practical guidance.
Astrology, when done correctly, is a science of timing and probability. My commitment is clarity, accuracy, and integrity.
              </p>
